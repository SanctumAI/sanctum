  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        title={isDisabled ? 'No messages to export' : 'Export conversation'}
      >
          ...
          <div className="p-1">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] text-text-muted">.md file</p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] text-text-muted">.txt file</p>
              </div>
            </button>
          </div>
        </div>
